...
public class Intersection {
    ...
    @Nullable
    public static PointF detect(Line l1, Line l2) {
        ...
        if ((x1line1 == x1line2) && (y1line1 == y1line2)) {
            return (new PointF((float) x1line1, (float) y1line1));
        }
        ...
        if ((x2line1 == x1line2) && (y2line1 == y1line2)) {
            return (new PointF((float) x2line1, (float) y2line1));
        }
        ...
        return (new PointF((float) (-(e * dxline2 - dxline1 * f) / (dyline1 * dxline2 - dyline2 * dxline1)),
